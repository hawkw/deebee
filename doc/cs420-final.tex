...
A \texttt{DELETE TABLE} statement simply consists of the keywords \texttt{DELETE TABLE} followed by the name of the table to be deleted. \Cref{lst:delete} provides an example of such a statement.

\begin{listing}[h]
    \begin{minted}[gobble=8]{SQL}
        DELETE TABLE Writers;
\end{minted}
\caption{Example SQL \texttt{DELETE TABLE} statement.}
\label{lst:delete}
\end{listing}
